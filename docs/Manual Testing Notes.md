...
[LOOP] saveSelection: pinned 'Audio A (FancyLoop)' isPinned=false pos=7 (live 'Audio A (FancyLoop)' pos=7)
[LOOP] restore-selection check: live 'Audio A (FancyLoop)' pos=7 | pinned 'Audio A (FancyLoop)' isPinned=false pos=7
...
[LOOP] restore-selection check: live 'Audio A (FancyLoop)' pos=7 | pinned 'Audio A (FancyLoop)' isPinned=true pos=7
...
[LOOP] restore-selection check: live 'Template' pos=2 | pinned 'Audio A (FancyLoop)' isPinned=true pos=7
...
3. At this point, I have the following state, which is good and expected:
    - col6: FancyLoop (this track is selected)
        - child0: Monitor (currently at col7 of the main bank)
        - child1: Template (currently at abs pos 8, just right of the window)
        - child2: Layer 2 (currently at abs pos 9)
        - child3: Layer 1 (currently at abs pos 10)

4. Use the delete-last-layer gesture on the APC40:
...
[LOOP] restore-selection check: live 'Layer 2' pos=2 | pinned 'Layer 2' isPinned=true pos=2
[LOOP] rescan #484 settled bankScroll=8 | (no looper columns visible)

5. Now I have this state:
    - col0: Template
    - col1: Layer 2 (this track is selected)
    - col2 thru col7: non-looper tracks

6. Same behavior as last test, just with the pinned-ness tracking info.