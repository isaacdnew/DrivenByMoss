...
/**
 * Different colors to use for the pads and buttons of Launchkey Mk3.
 *
 * @author Jürgen Moßgraber
 */
@SuppressWarnings("javadoc")
public class LaunchkeyMk3ColorManager extends ColorManager
{
     ...
     * Constructor.
     */
    public LaunchkeyMk3ColorManager ()
    {
        this.registerColorIndex (AbstractFeatureGroup.BUTTON_COLOR_OFF, LAUNCHKEY_COLOR_BLACK);
